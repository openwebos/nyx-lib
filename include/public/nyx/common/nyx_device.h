 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_get_iterator(nyx_device_type_t type, nyx_device_filter_t filter, nyx_device_iterator_handle_t *iterator_out_ptr);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_iterator_get_next_id(nyx_device_iterator_handle_t iterator, nyx_device_id_t *id_out_ptr);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_release_iterator(nyx_device_iterator_handle_t iterator);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_open(nyx_device_type_t type, nyx_device_id_t id, nyx_device_handle_t* handle_ptr);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_set_operating_mode(nyx_device_handle_t handle, nyx_operating_mode_t mode);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_get_operating_mode(nyx_device_handle_t handle, nyx_operating_mode_t* mode_out_ptr);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_get_event_source(nyx_device_handle_t handle, int32_t* source_out_ptr);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_get_event(nyx_device_handle_t handle, nyx_event_handle_t* event_out_ptr);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_release_event(nyx_device_handle_t handle, nyx_event_handle_t event_handle);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_set_report_rate(nyx_device_handle_t handle, nyx_report_rate_t rate);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_get_report_rate(nyx_device_handle_t handle, nyx_report_rate_t *rate_out_ptr);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_set_property(nyx_device_handle_t handle, const char* property_name_in, void* property_value_in_ptr);
 ...
 *
 */
NYX_API_EXPORT nyx_error_t nyx_device_get_property(nyx_device_handle_t handle, const char* property_name_in,void** property_value_out_ptr);
