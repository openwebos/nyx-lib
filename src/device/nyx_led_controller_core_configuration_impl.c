...
nyx_error_t nyx_led_controller_core_configuration_create(nyx_led_controller_effect_type_t effect_type,
        nyx_led_controller_core_configuration_handle_t* handle_ptr)
{
    nyx_led_controller_core_configuration* configuration =
        (nyx_led_controller_core_configuration*)calloc(sizeof(nyx_led_controller_core_configuration), 1);
...
{
    nyx_led_controller_core_configuration* configuration = (nyx_led_controller_core_configuration*) handle;
...
nyx_error_t nyx_led_controller_core_configuration_get_param(
        nyx_led_controller_core_configuration_handle_t handle, nyx_led_controller_parameter_type_t param, int32_t* value)
{
    nyx_led_controller_core_configuration* configuration = (nyx_led_controller_core_configuration*) handle;
